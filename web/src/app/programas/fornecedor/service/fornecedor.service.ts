...
export class FornecedorService {
  ...
  buscarFornecedoresFiltro(razaosocial: string): Observable<Fornecedor[]> {
    return this.http.get<Fornecedor[]>(`${this.API_URL}/fornecedor/pesquisar?razaosocial=${razaosocial}`).pipe(
      catchError(this.errorHandlerService.handleError)
    );
  }
